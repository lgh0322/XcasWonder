...
namespace xcas {
    ...
    public:
        ...
        void draw(cairo_surface_t *cs, unsigned char **png_array, int *lenght, double r, double g,
                  double b);
    ...
    private:
        ...
        void check_fl_draw(const char *ch, int i0, int j0, int imin, int jmin, int di, int dj,
        ...
        void check_fl_rectf(int i0, int j0, int i1, int j1, int imin, int jmin, int di, int dj,
                            int delta_i, int delta_j);

        void check_fl_line(int i0, int j0, int i1, int j1, int imin, int jmin, int di, int dj,
                           int delta_i, int delta_j);
