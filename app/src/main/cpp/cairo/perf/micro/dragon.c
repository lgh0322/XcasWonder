...
dragon(cairo_perf_t *perf, cairo_t *cr, int width, int height) {
    ...
    cairo_perf_run(perf, "dragon-unaligned-solid-aligned-clip",
                   do_dragon_unaligned_solid_aligned_clip, NULL);
    cairo_perf_run(perf, "dragon-solid-unaligned-clip", do_dragon_solid_unaligned_clip, NULL);
    cairo_perf_run(perf, "dragon-unaligned-solid-unaligned-clip",
                   do_dragon_unaligned_solid_unaligned_clip, NULL);
