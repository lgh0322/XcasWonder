...
cairo_gobject_text_cluster_flags_get_type(void) {
    ...
    if (g_once_init_enter(&type_volatile)) {
        ...
        GType type = g_enum_register_static(g_intern_static_string("cairo_text_cluster_flags_t"),
                                            values);
...
cairo_gobject_subpixel_order_get_type(void) {
    ...
    if (g_once_init_enter(&type_volatile)) {
        ...
        GType type = g_enum_register_static(g_intern_static_string("cairo_subpixel_order_t"),
                                            values);
...
cairo_gobject_path_data_type_get_type(void) {
    ...
    if (g_once_init_enter(&type_volatile)) {
        ...
        GType type = g_enum_register_static(g_intern_static_string("cairo_path_data_type_t"),
                                            values);
...
cairo_gobject_region_overlap_get_type(void) {
    ...
    if (g_once_init_enter(&type_volatile)) {
        ...
        GType type = g_enum_register_static(g_intern_static_string("cairo_region_overlap_t"),
                                            values);
