...
i965_stream_emit (i965_stream_t
*stream,
...
static cairo_always_inline void
        i965_stream_align(i965_stream_t * stream, uint32_t
size)
{
stream->
used = (stream->used + size - 1) & -size;
}

static cairo_always_inline void *
        i965_stream_alloc(i965_stream_t * stream, uint32_t
align,
uint32_t size
)
{
...
static cairo_always_inline uint32_t
i965_stream_offsetof (i965_stream_t
*stream,
const void *ptr
)
{
return (char *) ptr - (char *) stream->
data;
}
...
*
i965_surface_create_internal (cairo_drm_device_t
*base_dev,
cairo_format_t format,
int width,
int height,
...
i965_clip_and_composite_spans (i965_surface_t
*dst,
cairo_operator_t op,
...
cairo_private cairo_status_t
i965_shader_acquire_pattern (i965_shader_t
*shader,
...
cairo_private cairo_status_t
i965_shader_commit (i965_shader_t
*shader,
i965_device_t *device
);
...
cairo_private cairo_status_t
i965_device_flush (i965_device_t
*device);

cairo_private cairo_status_t
i965_fixup_unbounded (i965_surface_t
*dst,
const cairo_composite_rectangles_t *extents,
        cairo_clip_t
*clip);
