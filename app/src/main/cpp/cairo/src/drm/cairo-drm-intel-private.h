...
intel_bo_madvise (intel_device_t
*device,
intel_bo_t *bo,
int madv
);
...
intel_device_init (intel_device_t
*device,
int fd
);
...
*
intel_bo_create (intel_device_t
*dev,
uint32_t max_size,
        uint32_t
real_size,
...
cairo_private intel_bo_t
*
intel_bo_create_for_name (intel_device_t
*dev,
uint32_t name
);
...
cairo_private cairo_status_t
intel_bo_put_image (intel_device_t
*dev,
intel_bo_t *bo,
...
cairo_private cairo_status_t
intel_buffer_cache_init (intel_buffer_cache_t
*cache,
...
cairo_private cairo_status_t
intel_gradient_render (intel_device_t
*device,
...
intel_get_glyph (intel_device_t
*device,
...
cairo_private cairo_status_t
intel_snapshot_cache_insert (intel_device_t
*device,
