...
static cairo_status_t
_cairo_skia_context_set_source_rgba(void *abstract_cr, double red, double green, double blue,
                                    double alpha) {
    cairo_skia_context_t *cr = (cairo_skia_context_t *) abstract_cr;
...
_cairo_skia_context_set_fill_rule(void *abstract_cr,
    ...
    cr->path->setFillType(fill_rule == CAIRO_FILL_RULE_WINDING ? SkPath::kWinding_FillType
